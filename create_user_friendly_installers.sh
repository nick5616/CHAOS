#!/bin/bash
# Create user-friendly installers for end users

echo "Creating user-friendly installers..."

# Create macOS .dmg-style installer (simple drag-and-drop)
cat > install_chaos_macos.app/Contents/MacOS/install_chaos_macos << 'MACOS_INSTALLER_EOF'
#!/bin/bash
...
# Create Windows .exe-style installer (PowerShell script)
cat > install_chaos_windows.ps1 << 'WINDOWS_INSTALLER_EOF'
...
Read-Host "Press Enter to exit"
WINDOWS_INSTALLER_EOF

echo "User-friendly installers created!"
echo ""
echo "For macOS users:"
echo "  - Double-click: install_chaos_macos.app"
echo "  - Or run: open install_chaos_macos.app"
echo ""
echo "For Windows users:"
echo "  - Right-click: install_chaos_windows.ps1"
